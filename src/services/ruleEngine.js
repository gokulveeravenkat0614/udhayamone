// Statutory Eligibility, Conditional Rules & Approval Dependency Engine for UdyamOne (ES Module)
...
export function calculateMSMEClassification(investmentCr, turnoverCr) {
...
export function calculatePollutionCategory(industry, profile = {}) {
  if (industry === 'Information Technology') {
    return {
      category: 'White',
      badgeColor: 'slate',
      description: 'White Category: Non-polluting ITES sector. Exempt from CTE and CTO under CPCB guidelines.',
      cteRequired: false,
      ctoRequired: false
    };
  }
...
export function getJurisdictionAuthorities(state, district) {
...
export function getMasterApprovalCatalog(state, district) {
  ...
  return [
    {
      ...
      prerequisites: ['app-building', 'app-fire', 'app-pollution', 'app-electricity'],
      requiredDocs: [
      ...
      evaluate: (profile) => {
        ...
        if (profile.employeeCount >= threshold) {
          return {
            applicable: true,
            reason: 'May apply to manufacturing establishments employing 10+ workers with power (or 20+ workers without power) under Section 6 of Factories Act, 1948.',
    ...
    },
    {
      ...
      evaluate: (profile) => {
        ...
        return {
          applicable: true,
          reason: 'May apply to industrial establishments based on pollution classification (Red, Orange, Green) under Water Act 1974 and Air Act 1981.',
    ...
    },
    {
      ...
      evaluate: (profile) => {
        ...
        return {
          applicable: true,
          reason: 'May apply depending on total built-up area, building height, industrial hazard class, and National Building Code guidelines.',
    ...
    },
    {
      ...
      evaluate: (profile) => {
        ...
        return {
          ...
          reason: 'May apply to industrial establishments requiring dedicated High Tension (HT) or Low Tension (LT) power supply.',
    ...
    },
    {
      ...
      evaluate: (profile) => {
        ...
        return {
          applicable: true,
          reason: 'Required for all units manufacturing, processing, packaging, or storing food consumables under Food Safety and Standards Act, 2006.',
          trigger: 'Food Processing Sector'
        };
      }
    },
    {
      ...
      evaluate: (profile) => {
        ...
        return {
          applicable: true,
          reason: 'Mandated for pharmaceutical and bulk drug manufacturing units under Schedule M of Drugs & Cosmetics Act, 1940.',
    ...
    {
      id: 'app-peso',
      name: 'PESO Explosives / Hazardous Chemical Storage License',
      category: 'Industry-Specific Approvals',
      state,
      district,
      department: 'Petroleum and Explosives Safety Organization (PESO), DPIIT',
      authority: 'Petroleum and Explosives Safety Organization (PESO), DPIIT',
      officialSource: 'Petroleum Act 1934 / Explosives Act 1884 & Rules',
      sourceUrl: 'https://peso.gov.in',
      phase: 4,
      phaseName: 'Pre-Operation & Final Licenses',
      estimatedDays: '30 - 45 days',
      renewalPeriod: '3 to 5 years renewal under PESO rules',
      description: 'Clearance for bulk storage of hazardous compressed gases, petroleum products, and combustible solvents.',
      ...
      evaluate: (profile) => {
        ...
        return {
          applicable: true,
          reason: 'May apply to facilities storing, handling, or processing hazardous petroleum solvents, compressed gases, or flammables.',
...
export function getMasterRegistrationsCatalog(profile) {
...
export function buildDependencyGraph(applicableApprovals, userApplications = []) {
...
export function buildRecommendedSequence(auth = {}) {
...
export function evaluateEligibilityAndDependencies(input = {}, userApplications = []) {
