    ...
    <div id="schemes-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-400/20 border border-amber-400/30 text-amber-300 text-xs font-bold">
              ...
              <span>Incentives & Subsidies Desk</span>
              <span className="text-amber-400/50">•</span>
              <span className="text-amber-200">Demonstration Data</span>
            </div>
            ...
            <p className="text-blue-100 text-sm sm:text-base max-w-2xl font-normal leading-relaxed">
              Explore Central and State incentive schemes, collateral-free credit facilities, technology upgradation grants, and green manufacturing subsidies.
            </p>
          </div>
          ...
          <div className="shrink-0">
            ...
            >
              ...
              <span>Run Quick Eligibility Checker →</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="p-3.5 rounded-2xl bg-amber-50 border border-amber-200 text-amber-900 text-xs flex items-center justify-between shadow-2xs">
        <div className="flex items-center space-x-2.5">
          ...
          <span>
            <strong>Demonstration / Prototype Notice:</strong> Scheme terms, subsidy limits, and eligibility matrices shown below are representative demonstration data for the Smart India Hackathon MVP prototype.
          </span>
        </div>
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-slate-200 animate-scaleUp relative">
            ...
            <div className="mt-5 space-y-4 text-xs text-slate-700">
              <div className="p-4 rounded-2xl bg-blue-50/70 border border-blue-100">
                <div className="font-bold text-brand-900 mb-1">Financial Incentive & Terms</div>
                <div>{selectedSchemeForModal.subsidyDetails}</div>
              </div>

              <div>
                <strong className="block text-slate-900 mb-1">Eligibility Verification</strong>
                <p className="text-slate-600 leading-relaxed">
                  Your proposed unit in <strong>{selectedState}</strong> ({selectedIndustry}) meets the foundational parameters for this support framework.
                </p>
              </div>

              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between">
                <span className="text-slate-500">Nodal Implementing Agency:</span>
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
              ...
              >
                <span>Apply via Nodal Portal</span>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-slate-200 animate-scaleUp relative">
            ...
            <div className="flex items-center space-x-2 text-xs font-bold text-amber-600 uppercase tracking-wider mb-1">
              <Coins className="w-4 h-4" />
              <span>Instant Eligibility Engine</span>
            </div>

            <h3 className="text-2xl font-black text-slate-900">
              Check Your Scheme Subsidies
            </h3>
            <p className="text-xs text-slate-500 mt-1">
              Answer 3 brief questions to view government subsidies tailored to your project scale.
            </p>
              ...
              <form onSubmit={handleRunAssessment} className="mt-6 space-y-4 text-xs">
                <div>
                  <label className="block font-bold text-slate-700 mb-1.5">
                    1. Proposed Plant & Machinery Capital Investment
                  </label>
                  <select
                ...
                <div>
                  <label className="block font-bold text-slate-700 mb-1.5">
                    2. Expected Annual Turnover (Year 1)
                  </label>
                  <select
                    value={quizTurnover}
              ...
              <div className="mt-6 space-y-4 animate-fadeIn text-xs">
                <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200">
                  <div className="flex items-center space-x-2 text-emerald-800 font-bold text-sm">
                    ...
                    <span>Classification: {quizResult.msmeClass}</span>
                  </div>
                  <div className="mt-2 text-xs text-emerald-900 font-medium">
                    Estimated Benefit: <strong>{quizResult.estimatedIncentive}</strong>
                  </div>
                </div>

                <div>
                  <div className="font-bold text-slate-900 mb-2">Matched Top 3 Central & State Schemes:</div>
